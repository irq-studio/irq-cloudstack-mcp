...
class CloudStackCli {
  ...
  private async callMcpServer(toolCall: ToolCall): Promise<McpResponse> {
  ...
  private parseArguments(args: string[]): { options: CliOptions; command: string; toolArgs: Record<string, unknown> } {
  ...
  private formatOutput(data: McpResponse): void {
    switch (this.format) {
      case 'json':
      ...
      default:
        if (data.content && Array.isArray(data.content)) {
          data.content.forEach((item: McpContentItem) => {
...
Commands:
  ...
  Infrastructure:
    ...
    info [--format <table|json|compact>] - CloudStack instance information
  ...
  Monitoring:
    ...
    delete-events [--ids <id1,id2>] [--type <type>] [--start-date <date>] [--end-date <date>]
    archive-events [--ids <id1,id2>] [--type <type>] [--start-date <date>] [--end-date <date>]
    list-alerts [--type <type>]
    delete-alerts [--ids <id1,id2>] [--type <type>] [--start-date <date>] [--end-date <date>]
    archive-alerts [--ids <id1,id2>] [--type <type>] [--start-date <date>] [--end-date <date>]
